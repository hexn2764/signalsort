 ...
 * The reporter is a stand-in for reality, but reality that spams a repository is
 * a worse demo, not a better one. As the solver drains the backlog, room frees up
 * and the reporter files again — so the cap regulates the whole loop, not just agent 1.
 */
